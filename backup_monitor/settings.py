"""
Django settings for backup_monitor project.
...
SECRET_KEY = 'django-insecure-v!ex-blo=qnr#q0p8=+a)%1m%bvoy$ugr+++!xcq2ntf4hsslp'
...
WSGI_APPLICATION = 'backup_monitor.wsgi.application'


CELERY_BROKER_URL = 'redis://localhost:6379/0'
CELERY_BEAT_SCHEDULE = {
    'scan_backups_every_5_minutes': {
        'task': 'monitor.tasks.scan_backups',
        'schedule': 300.0,
    },
}
